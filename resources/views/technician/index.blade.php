    ...
    <div class="container-fluid content index-height student-index">
        <div class="row mt-4 h-100 pr-md-5 pl-md-5">
            <div class="col-md-12 col-xs-12 pr-md-5 pl-md-5 mb-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 text-left">
                                        <p class="mb-1 profile-title">Welcome Back, {{ $technician->technician_name }}!</p>
                                        <p class="mb-1 profile-subtitle">{{ Auth::user()->name}}</p>
                                        <p class="mb-1 profile-subtitle">{{ Auth::user()->role}}</p>
                                        <p class="mb-1 profile-subtitle">{{ $technician->technician_phone}}</p>
                                        <p class="mb-1 profile-subtitle">{{ $technician->technician_email}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row second-section pr-md-5 pl-md-5 mt-md-4">
