...
@section('content')
    <div class="container-fluid case-register login-section clerk-verify-show">
        <div class="row h-100 justify-content-center">
            <div class="col-xs-12 col-md-8">
                <div class="card h-100">
                    ...
                    <div class="card-body pr-5 pl-5 pt-3">
                        <form action="{{route('clerk.update', $dentalcase->case_id)}}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 offset-md-8 col-xs-12 mt-1">
                                    ...
                                    <input id="case_id" type="text" class="form-control @error('case_id') is-invalid @enderror" name="case_id" value="{{$dentalcase->case_id}}" required autocomplete="case_id" autofocus >
                            ...
                            <div class="form-group row">
                                <div class="col-md-8 col-xs-12 mt-1">
                                    ...
                                    <input id="student_name" type="text" class="form-control @error('student_name') is-invalid @enderror" name="student_name" value="{{ $dentalcase->student_name }}" required autocomplete="student_name" autofocus >
                                ...
                                <div class="col-md-4 col-xs-12 mt-1">
                                    ...
                                    <input id="student_id" type="text" class="form-control @error('student_id') is-invalid @enderror" name="student_id" value="{{ $dentalcase->student_id }}" required autocomplete="student_id" autofocus >
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-xs-12 mt-1">
                                    ...
                                    <input id="patient_name" type="text" class="form-control @error('dentist_name') is-invalid @enderror" name="patient_name" value="{{$dentalcase->patient_name}}" required autofocus >
...
@section('action_script')
    <script>
        ...
        window.onload = function()
        {
            ...
            var text = ["-", "Full", "Partial", "Chrome", "Immediate", "Study Model", "Splint",
            ...
            text.forEach(function(t)
            {
                ...
                option.setAttribute("value", t);
                option.innerHTML = t;
                case_1.appendChild(option);
                case_2.appendChild(option);
