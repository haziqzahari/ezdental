            ...
            <div class="col-xs-12 col-md-8">
                <div class="card h-100">
                    ...
                    <div class="card-body pr-5 pl-5">
                        <form action="{{ route('clerk.verifycase', $dentalcase->case_id) }}" method="POST">
                            @csrf
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="row justify-content-xs-center justify-content-md-end pr-md-3">
                                        @if ($dentalcase->verification_status == 1)
                                            {{-- <a href="/clerk/{{$dentalcase->case_id}}/edit" class="btn btn-success-outline">Edit</a> --}}
                                        @else
                                            <a href="/clerk/{{$dentalcase->case_id}}/edit" class="btn btn-success-outline mr-3">Edit</a>
