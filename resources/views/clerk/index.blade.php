                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 pl-md-5 text-left">
                                        <p class="mb-1 profile-title">Welcome Back, {{ $clerk->clerk_name }}!</p>
                                        <p class="mb-1 profile-subtitle">{{ Auth::user()->name}}</p>
                                        <p class="mb-1 profile-subtitle">{{ Auth::user()->role}}</p>
                                        <p class="mb-1 profile-subtitle">{{ $clerk->clerk_phone}}</p>
                                        <p class="mb-1 profile-subtitle">{{ $clerk->clerk_email}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row second-section pr-md-5 pl-md-5 mt-md-5">
                    <div class="col-md-12">
                        <div class="card h-100 table-index">
                            ...
                            <div class="card-footer text-success">{{$dentalcases->links()}}</div>
                        </div>
                    </div>
                </div>
            </div>
