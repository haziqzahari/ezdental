            ...
            <div class="col-xs-12 col-md-8">
                <div class="card h-100">
                    ...
                    <div class="card-body pr-5 pl-5">
                        <form action="{{ route('dentist.registercase') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-md-8 col-xs-12 mt-1">
                                    ...
                                    <input id="dentist_name" type="text" class="form-control @error('dentist_name') is-invalid @enderror" name="dentist_name" value="{{$dentist->dentist_name}}" required autocomplete="dentist_name" autofocus>
                                ...
                                <div class="col-md-4 col-xs-12 mt-1">
                                    <label for="dentist_id" class="col-md-12 pl-0">{{ __('Dentist ID') }}</label>
                                    <input id="dentist_id" type="text" class="form-control @error('dentist_id') is-invalid @enderror" name="dentist_id" value="{{Auth::user()->name}}" required autocomplete="dentist_id" autofocus>
